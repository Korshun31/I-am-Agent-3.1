...
TD-064: Нет миниатюр фотографий — везде загружается полноразмерное фото (1200px) даже для карточек объектов и аватарок контактов 64-80px
Что сделать: при загрузке создавать два файла в Storage — полное (1200px) и миниатюру (150px). Хранить оба URL. В списках и превью использовать миниатюру. Применить к фото объектов и фото-аватарам контактов одной волной.
