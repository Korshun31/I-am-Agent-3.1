...
TD-002: contacts не имеет company_id
Что сделать: добавить company_id колонку и обновить RLS

TD-003: CONTEXT_FOR_AI.md содержит устаревшие планы разработки
Что сделать: переписать файл — убрать планы, оставить только текущее состояние
