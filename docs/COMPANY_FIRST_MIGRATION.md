...
### 4.3 Contact Access Contract

> Зафиксировано 2026-03-27 как часть company-first модели.

| Субъект | Что видит | Политика |
|---|---|---|
| **owner/admin** | Все контакты компании (full CRUD) | `contacts: owner full access to company` |
| **agent** | Только свои созданные контакты | `contacts: agent read own` |
| **agent** | Собственники объектов, где он ответственный (`owner_id`, `owner_id_2`) | `contacts: agent reads property owners` |
