...
**UI-1.1.** *(TD-019)* На вебе вместо Preloader показывается экран входа во время проверки сессии. Залогиненный пользователь видит мелькание экрана входа.
...
|---|---|---|
| **TD-019** | Веб: Preloader не показывается при проверке сессии — мелькает экран входа (ранее зафиксирован) | Низкий |
