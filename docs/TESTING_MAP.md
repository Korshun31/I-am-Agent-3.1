...
| B9 | 3 | — | Web: после деактивации агента визуально не обновляется статус в списке команды (данные в БД корректны). | src/web/components/WebTeamSection.js | ⬜ |
...
| B12 | 3 | — | При регистрации агента через invitation — админ не получает уведомление и приглашение висит как неподтверждённое до перезагрузки страницы. | src/web/components/WebTeamSection.js | ⬜ |
