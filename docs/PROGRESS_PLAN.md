...
### Фаза 9 — Технический долг кода (1 день)
TD-030 (аудит-лог действий с командой). Всё что было запланировано в фазе (TD-020, TD-035, TD-043, TD-001, TD-034, TD-036, TD-037, TD-045, TD-047, TD-060, TD-004, TD-010, TD-012, TD-115) закрыто параллельно с другими фазами в апреле-мае.
...
- ✅ Закрыто: **116** TD
- ⬜ Не начато: **4** TD: TD-030 (аудит-лог команды), TD-090 (Web Push в браузер = P3-003), TD-108 (Web Push календарных событий), TD-118 (native deep links для confirmation/recovery).
